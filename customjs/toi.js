...
function maincontent() {
    ...
    ourRequest.open('GET', 'https://newsapi.org/v1/articles?source=the-times-of-india&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
...
function slide(z) {
    var ourRequest = new XMLHttpRequest();
    if (z == 1) {
        ourRequest.open('GET', 'https://newsapi.org/v1/articles?source=the-hindu&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
    }
    if (z == 2) {
        ourRequest.open('GET', ' https://newsapi.org/v1/articles?source=the-telegraph&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
    }
    if (z == 3) {
