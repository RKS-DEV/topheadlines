...
function slide(z) {
    var ourRequest = new XMLHttpRequest();
    if (z == 1) {
        ourRequest.open('GET', 'https://newsapi.org/v1/articles?source=business-insider&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
    }
    if (z == 2) {
        ourRequest.open('GET', 'https://newsapi.org/v1/articles?source=cnbc&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
    }
    if (z == 3) {
        ourRequest.open('GET', 'https://newsapi.org/v1/articles?source=fortune&sortBy=top&apiKey=69e7fad93b294937beb6ec4d16434e2c');
    }
